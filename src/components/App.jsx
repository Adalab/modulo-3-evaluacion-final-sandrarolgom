...
function App() {
  ...
  const filterCharacter = listCharacters
    .filter((item) =>
  ...
  return (
    <Routes>
          ...
          <>
            <header className="header">
              <img
                ...
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Harry_Potter_wordmark.svg/800px-Harry_Potter_wordmark.svg.png"
                alt=""
              />
            </header>
            <Filters
      ...
      <Route
        path="/detail/:id"
        element={<CharacterDetail data={character} />}
      />
    </Routes>
  );
}
